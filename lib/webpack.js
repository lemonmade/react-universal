...
function webpackConfigFactory({ target, mode }, { projectRoot, appDir, dataDir, clientDevServerPort, buildDir }) {
  ...
  return {
    ...
    entry: merge({
      main: removeEmpty([ifDevClient('react-hot-loader/patch'), ifDevClient(`webpack-hot-middleware/client?reload=true&path=http://localhost:${ clientDevServerPort }/__webpack_hmr`), _path2.default.resolve(projectRoot, `./${ target }.js`)])
    }),
    output: {
